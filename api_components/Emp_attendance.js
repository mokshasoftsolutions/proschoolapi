...
// Modified
//Get Employee Attendence by Date

// router.route('/employee_attendance_status/:date')
//     .get(function(req, res, next) {
//         var resultArray = [];
//          date= req.params.date,
//       mongo.connect(url, function(err, db) {
//             assert.equal(null, err);
//             var cursor = db.collection('employee_attendance').find({date:date});
//             cursor.forEach(function(doc, err) {
//                 assert.equal(null, err);
//                 resultArray.push(doc);
//             }, function() {
//                 db.close();
//                 res.send({
//                    employee_attendance : resultArray
//                 });
//             });
//         });
//     });
